...
export const Home = () => {
  const { user, isLoading } = useUser(); // Assuming your hook provides loading state
  ...
  return (
    <main className="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100">
      <div className="container mx-auto px-6 py-8">
        <h1 className="text-3xl font-semibold text-gray-900">Welcome back, {user.name || 'User'}</h1>
