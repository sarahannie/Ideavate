...
<footer className="bg-white">
  <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    <div className="lg:flex  lg:gap-8">
      ...
      <div className="mt-8 lg:items-start grid grid-cols-2 lg:gap-14 gap:8 lg:mt-0 lg:grid-cols-6 lg:gap-y-16">
        <div className="col-span-3">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Join our newsletter</h2>

            <p className="mt-4 text-gray-500">
              We will send you a nice newsletter once per week, No spam.
            </p>
          </div>
        </div>

        <div className="col-span-3 lg:justify-self-end lg:col-span-3 lg:flex lg:items-end">
        ...
        <h3 className="text-2xl font-bold text-green text-start">Ideavate fund</h3>
    ...
    <div className="mt-8 border-t border-gray-100 pt-8">
      <div className="sm:flex sm:justify-between">
        <p className="text-xs text-gray-500">&copy; 2025. Ideavate fund. All rights reserved.</p>
